...
class Plan(object):
    ...
    def __init__(self, name=None, pretty_name=None, recurring_billing_mode=None, billing_period=None, phases=None, _configuration=None):  # noqa: E501
    ...
    def recurring_billing_mode(self, recurring_billing_mode):
        ...
        if (self._configuration.client_side_validation and
                recurring_billing_mode not in allowed_values):
            raise ValueError(
                "Invalid value for `recurring_billing_mode` ({0}), must be one of {1}"  # noqa: E501
                .format(recurring_billing_mode, allowed_values)
            )

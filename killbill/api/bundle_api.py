...
class BundleApi(object):
    ...
    def transfer_bundle_with_http_info(self, bundle_id, body, x_killbill_created_by, **kwargs):  # noqa: E501
        ...
        all_params = ['bundle_id', 'body', 'x_killbill_created_by', 'requested_date', 'billing_policy', 'bcd_transfer', 'plugin_property', 'x_killbill_reason', 'x_killbill_comment']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')

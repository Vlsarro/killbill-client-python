...
class AccountApi(object):
    ...
    def get_account_bundles_paginated(self, account_id, **kwargs):  # noqa: E501
        """Retrieve paginated bundles for account  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_account_bundles_paginated(account_id, async_req=True)
        >>> result = thread.get()
    ...
    def get_account_bundles_paginated_with_http_info(self, account_id, **kwargs):  # noqa: E501
        """Retrieve paginated bundles for account  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_account_bundles_paginated_with_http_info(account_id, async_req=True)
        >>> result = thread.get()
    ...
    def get_invoices_for_account_paginated(self, account_id, **kwargs):  # noqa: E501
        """Retrieve paginated invoices for account  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_invoices_for_account_paginated(account_id, async_req=True)
        >>> result = thread.get()
    ...
    def get_invoices_for_account_paginated_with_http_info(self, account_id, **kwargs):  # noqa: E501
        """Retrieve paginated invoices for account  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_invoices_for_account_paginated_with_http_info(account_id, async_req=True)
        >>> result = thread.get()
    ...
    def rebalance_existing_cbaon_account(self, account_id, x_killbill_created_by, **kwargs):  # noqa: E501
        """Rebalance account CBA  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rebalance_existing_cbaon_account(account_id, x_killbill_created_by, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.rebalance_existing_cbaon_account_with_http_info(account_id, x_killbill_created_by, **kwargs)  # noqa: E501
        else:
            (data) = self.rebalance_existing_cbaon_account_with_http_info(account_id, x_killbill_created_by, **kwargs)  # noqa: E501
            return data

    def rebalance_existing_cbaon_account_with_http_info(self, account_id, x_killbill_created_by, **kwargs):  # noqa: E501
        """Rebalance account CBA  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rebalance_existing_cbaon_account_with_http_info(account_id, x_killbill_created_by, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method rebalance_existing_cbaon_account" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'account_id' is set
        if self.api_client.client_side_validation and ('account_id' not in params or
                                                       params['account_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `account_id` when calling `rebalance_existing_cbaon_account`")  # noqa: E501
        # verify the required parameter 'x_killbill_created_by' is set
        if self.api_client.client_side_validation and ('x_killbill_created_by' not in params or
                                                       params['x_killbill_created_by'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `x_killbill_created_by` when calling `rebalance_existing_cbaon_account`")  # noqa: E501

        if self.api_client.client_side_validation and ('account_id' in params and not re.search(r'\\w+-\\w+-\\w+-\\w+-\\w+', params['account_id'])):  # noqa: E501
            raise ValueError("Invalid value for parameter `account_id` when calling `rebalance_existing_cbaon_account`, must conform to the pattern `/\\w+-\\w+-\\w+-\\w+-\\w+/`")  # noqa: E501
        collection_formats = {}

...
class CatalogApi(object):
    ...
    def validate_catalog_xml(self, body, x_killbill_created_by, **kwargs):  # noqa: E501
        """Validate a XML catalog  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.validate_catalog_xml(body, x_killbill_created_by, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.validate_catalog_xml_with_http_info(body, x_killbill_created_by, **kwargs)  # noqa: E501
        else:
            (data) = self.validate_catalog_xml_with_http_info(body, x_killbill_created_by, **kwargs)  # noqa: E501
            return data

    def validate_catalog_xml_with_http_info(self, body, x_killbill_created_by, **kwargs):  # noqa: E501
        """Validate a XML catalog  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.validate_catalog_xml_with_http_info(body, x_killbill_created_by, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('x_killbill_created_by' not in params or
                                                       params['x_killbill_created_by'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `x_killbill_created_by` when calling `validate_catalog_xml`")  # noqa: E501
